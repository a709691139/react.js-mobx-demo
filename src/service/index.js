class Service {
  ...
  getProjects(sendData) { //获取 视频列表
    let data = [{
      ...
      "intro": ["已上线，安卓和苹果，采用react-nativeApp 技术。", "信息展示平台，用来展示企业的新闻信息，内有原生百度地图功能、gps定位、二维码扫码等功能。"],
      "id": 0
    }, {
      "type": "nativeApp",
      "title": "跳舞宝手机app@1.x",
      ...
      "intro": ["已上线，安卓和苹果，采用react-nativeApp 技术。", "第一代版本是单纯的连接蓝牙，获取歌单列表，然后控制音响播放音乐，可编辑顺序。"],
      "id": 1
    }, {
      "type": "nativeApp",
      "title": "跳舞宝手机app@2.x",
      ...
      "intro": ["未上线，安卓和苹果，采用react nativeApp + mobx技术。", "已完成了软件前端界面和功能实现，后端未完成。", "功能：展示信息、扫码、搜索、手机本地音乐视频播放，管理下载的音乐和视频，蓝牙连接音响，门店地图搜索。"],
      "id": 2
    }, {
      "type": "nativeApp",
      "title": "健康中心app",
      ...
      "intro": ["已上线，安卓和苹果，采用react nativeApp + mobx技术。", "主要用来获取用户健康数据，然后转成图表展示。"],
      "id": 3
    }, {
      "type": "webApp",
